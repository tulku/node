...
intermediates_rel := out/$(APP_OPTIM)
intermediates := $(LOCAL_PATH)/$(intermediates_rel)
...
V8_GENERATED_LIBRARIES := $(intermediates_rel)/libraries.cc
...
LOCAL_SRC_FILES += $(V8_GENERATED_LIBRARIES)
